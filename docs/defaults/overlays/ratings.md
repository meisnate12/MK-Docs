...
Recommendations: Use the [Mass * Rating Update Library Operation](../../config/operations/#mass--rating-update) and the [Mass Episode * Rating Update Library Operation](../../config/operations/#mass-episode--rating-update) to update Plex to the Ratings you want on the Overlay.
