...
Requirements: Use the [Mass Content Rating Update Library Operation](../../config/operations/#mass-content-rating-update) with either `mdb` or `omdb` to update Plex to the BBFC Rating.
